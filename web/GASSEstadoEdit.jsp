         ...
         <div class="page-header">
             ...
             <div class="row-fluid">
              ...
              <h:panelGrid columns="2" styleClass="table table-hover" > 
                ...
                <h:inputText styleClass="form-signin input-block-level" id="nome" value="#{estado.estado.nome}" title="Nome" required="true" requiredMessage="The nome field is required." />
                
            </h:panelGrid>
            <br />
                   
            <h:commandButton styleClass="btn btn-primary" action="#{estado.editGass}" value="Salvar">
