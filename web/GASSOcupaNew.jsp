        ...
        <body>
            ...
            <div class="row-fluid">
                <div class="span4">
                 ...
                 <%--               <h:inputText  id="socio" value="#{ocupa.ocupa.socio.candidato.candidatoPK.email}" title="Socio" required="true" requiredMessage="The socio field is required." />
                        --%>       <h:selectOneMenu  id="socio" value="#{ocupa.ocupa.socio}" title="Socio" required="true" requiredMessage="The socio field is required." >
                                    <f:selectItems value="#{ocupa.sociosForAssoc2}"/>
                                </h:selectOneMenu>
                                ...
                                <h:commandButton styleClass="btn btn-primary" action="#{ocupa.createGass}" value="Criar"/>
