                ...
                <h:form styleClass="form-horizontal well">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <h:outputText id="nrSocio" value="#{socio.socio.nrSocio}" title="NrSocio" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <h:inputText styleClass="form-signin input-block-level" id="dataNasc" value="#{socio.socio.candidato.dataNasc}" title="Data Nascimento" required="true" requiredMessage="O campo \"Data de Nascimento\" é obrigatório.">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <h:selectOneMenu id="tiposocio" value="#{socio.socio.tiposocio}" title="TipoSocio" required="true" requiredMessage="The estado field is required." >
                                    <f:selectItems value="#{socioWorker.tipoItemsAvailableSelectOne(socio.socio.socioPK.NIFAssociacao)}"/>
                                </h:selectOneMenu>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <h:commandButton styleClass="btn btn-primary" action="#{socio.editSoss1}" value="Guardar" onclick="return popupConfirm()">
                            ...
                            &nbsp 
                            <h:commandButton styleClass="btn" action="#{socio.detailSocioSetup1}" value="Cancelar" immediate="true" onclick="return popupCancel()">
                                <f:param name="jsfcrud.currentSocio" value="#{jsfcrud_class['entitiesGASS.jsf.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][socio.socio][socio.converter].jsfcrud_invoke}"/>
                            </h:commandButton>
                        </div>
                    </fieldset>
