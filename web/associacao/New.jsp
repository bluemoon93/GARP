...
<f:view>
    <html>
        ...
        <h1>New Associacao</h1>
        <h:form>
            <h:inputHidden id="validateCreateField" validator="#{associacao.validateCreate}" value="value"/>
            <h:panelGrid columns="2">
                <h:outputText value="Nif:"/>
                <h:inputText id="nif" value="#{associacao.associacao.nif}" title="Nif" required="true" requiredMessage="The nif field is required." />
            ...
            <br />
            <h:commandLink action="#{associacao.create}" value="Create"/>
            <br />
            <br />
