    ...
    <html>
        ...
        <body>
            ...
            <div class="page-header">
                <h1> &nbsp Definir Sócios e Cargos</h1>
            </div>
            <div class="row-fluid">
                <div class="span4">
                    <div class="well">
                        <h:form >
                            <h:panelGrid columns="2" styleClass="table table-hover" > 
                                ...
                                <h:selectOneMenu id="tipo2" value="#{ocupaWorker.tipo}" title="Associacao" required="true" requiredMessage="The tiposocio field is required." >
                                    <f:selectItems value="#{ocupaWorker.tipoItemsAvailableSelectOne(10)}"/>
                                </h:selectOneMenu>

                                <h:outputText value="DataInicio (dd/MM/yyyy)"/>
                                <h:inputText styleClass="form-signin input-block-level" id="dataInicio" value="#{ocupaWorker.dataInicio}" title="DataInicio" required="true" requiredMessage="The dataInicio field is required." >
                                    <f:convertDateTime pattern="dd/MM/yyyy" />
                                </h:inputText>
                                <h:outputText value="DataFim (dd/MM/yyyy)"/>
                                <h:inputText styleClass="form-signin input-block-level" id="dataFim" value="#{ocupaWorker.dataFim}" title="DataFim" required="true" requiredMessage="The dataFim field is required." >
                                    <f:convertDateTime pattern="dd/MM/yyyy" />
                                </h:inputText>
                                <h:outputText value="Cargo:"/>
                                <h:selectOneMenu id="cargo" value="#{ocupaWorker.cargo}" title="Cargo" required="true" requiredMessage="The cargo field is required." >
                                    <f:selectItems value="#{cargo.cargoItemsAvailableSelectOne}"/>
                                </h:selectOneMenu>
                                <h:commandButton styleClass="btn btn-primary" action="#{ocupa.createGass2}" value="Criar"/>
