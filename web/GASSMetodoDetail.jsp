...
<f:view>
    <html>
      <head>
            ...
            <title>Detalhes Método de Passagem</title>
        ...
        <body>
          ...
          <div class="page-header">
                <h1> &nbsp Detalhes Método de Passagem</h1>
        </div> 
          ...
          <%--<form class="form-horizontal well">--%>
             ...
             <div class="row-fluid">
              ...
              <h:panelGrid columns="2" styleClass="table table-hover" > 
                    ...
                    <h:outputText value="#{metodopassagem.metodopassagem.dias} dias, #{metodopassagem.metodopassagem.meses} meses, #{metodopassagem.metodopassagem.anos} anos" title="Tempo" />

                    <h:outputText value="Estado Origem:"/>
                    <h:outputText value="#{metodopassagem.metodopassagem.estado1.nome}"/>

                    <h:outputText value="Estado Destino:"/>
                    <h:outputText value="#{metodopassagem.metodopassagem.estado.nome}"/>
                </h:panelGrid>
                <br />
                <br />
                 
                <h:commandButton styleClass="btn btn-primary" action="#{metodopassagem.editSetupGass}" value="Editar">
                ...
                <br />
                <br />
                <h:commandButton styleClass="btn" action="#{estado.detailSetupGass}" value="Cancelar" immediate="true">
