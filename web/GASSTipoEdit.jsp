                    ...
                    <div class="well">
                        <h:form styleClass="jsfcrud_list_form"> 
                            <h:panelGrid columns="2" styleClass="table table-hover" > 
                                ...
                                <h:inputText styleClass="form-signin input-block-level" id="quantia" value="#{tiposocio.tiposocio.quantia}" title="Quantia" required="true" requiredMessage="The quantia field is required." />
                            </h:panelGrid>


                            <h:commandButton styleClass="btn btn-primary" action="#{tiposocio.editGass}" value="Guardar">
                            ...
                            <br />
                            <br />
                            <h:commandButton styleClass="btn"  action="#{tiposocio.removeGass(tiposocio.tiposocio)}" value="Apagar" immediate="true" >
                                <f:param name="jsfcrud.currentTiposocio" value="#{jsfcrud_class['entitiesGASS.jsf.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][tiposocio.tiposocio][tiposocio.converter].jsfcrud_invoke}"/>
                            </h:commandButton>
                            <br />
                            <br />
