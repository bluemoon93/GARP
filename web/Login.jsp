    ...
    <body>
        ...
        <div class="container">
            <h:form styleClass="form-signin">
                ...
                <h:outputText styleClass="input-block-level" value="Associacao "/>
                ...
                <br />
                <h:commandButton styleClass="btn btn-large btn-primary" type="submit" action="#{candidato.loginCandy}" value="Log-In" />
                <br />
                <br />
            </h:form>
            <h:form styleClass="form-signin">
                ...
                <h:commandButton styleClass="btn btn-large btn-primary" type="submit" action="#{candidato.recuperarPass}" value="Recuperar Pass" />
                <br />
                <br />
            </h:form>
    </body>
