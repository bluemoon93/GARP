                        ...
                        <h:form styleClass="jsfcrud_list_form"> 
                            ...
                            <h:panelGrid columns="2" styleClass="table table-hover" > 
                                ...
                                <h:selectOneMenu id="tipo2" value="#{socioWorker.tipoSocio}" title="Associacao" required="true" requiredMessage="The tiposocio field is required." >
                                    <f:selectItems value="#{socioWorker.tipoItemsAvailableSelectOne(1111)}"/>
                                </h:selectOneMenu>
                            </h:panelGrid>
                            <br/>
                            ...
                            <br />
                            <br/>
                            <h:commandButton styleClass="btn btn-primary" action="#{socio.createSoss(1111)}" value="Inscrever como Sócio"/>
                            <br />
                            <br />
                        </h:form>
                    </div>
