    ...
    <html>
        ...
        <h:form>
            ...
            <h:panelGrid columns="2">
                ...
                <h:inputText id="nif" value="#{socio.socio.socioPK.nif}" title="Nif" required="true" requiredMessage="The nif field is required." />
            ...
            <br />
            <h:commandLink action="#{socio.create}" value="Create"/>
            <br />
            <br />
